...
import { ValueOffer } from './pages/ValueOffer';
import { ThankYou } from './pages/ThankYou';

/**
 * Four routes. /offer is a single route — ValueOffer reads the real
 * main-order total and decides which offer to render, the way a hosted
 * funnel picks an edge with mainOrder.totalGreaterThan.
 */
    ...
    <TagadaHeadlessProvider storeId={STORE_ID} environment={ENVIRONMENT}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/offer" element={<ValueOffer />} />
