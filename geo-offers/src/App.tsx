...
import { GeoOffer } from './pages/GeoOffer';
import { ThankYou } from './pages/ThankYou';

/**
 * Four routes. /offer is a single route — GeoOffer decides which of the
 * three offers to render, the way a hosted funnel picks an edge.
 */
    ...
    <TagadaHeadlessProvider storeId={STORE_ID} environment={ENVIRONMENT}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/offer" element={<GeoOffer />} />
